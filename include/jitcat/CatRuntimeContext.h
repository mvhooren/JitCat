...
namespace jitcat
{
	...
	public:
		...
		CatRuntimeContext(const std::string& contextName, ExpressionErrorManager* errorManager = nullptr, CatHostClasses* hostClasses = nullptr);
		...
		CatHostClasses* getHostClasses() const;
		void setHostClasses(CatHostClasses* hostClasses);
	...
	private:
		...
		//Classes that can be instantiated and/or inherited by jitcat classes.
		CatHostClasses* hostClasses;
